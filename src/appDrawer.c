...
int appDrawer()
{
	...
	{
		backdrop = vita2d_load_PNG_file("ux0:/data/CyanogenVITA/system/home/menu/backdropDark.png");
		fontColor = lightGray;
	}
	...
	while(1)
	{
		...
		vita2d_pgf_draw_textf(Roboto, 50, 225, fontColor, 0.9f, "Browser");
		...
		vita2d_pgf_draw_textf(Roboto, 203, 225, fontColor, 0.9f, "Camera");
		...
		vita2d_pgf_draw_textf(Roboto, 370, 225, fontColor, 0.9f, "Clock");
		...
		vita2d_pgf_draw_textf(Roboto, 510, 225, fontColor, 0.9f, "Manager");
		...
		vita2d_pgf_draw_textf(Roboto, 670, 225, fontColor, 0.9f, "Gallery");
		...
		vita2d_pgf_draw_textf(Roboto, 830, 225, fontColor, 0.9f, "Game");
		...
		vita2d_pgf_draw_textf(Roboto, 39, 405, fontColor, 0.9f, "Messenger");
		...
		vita2d_pgf_draw_textf(Roboto, 210, 405, fontColor, 0.9f, "Music");
		...
		vita2d_pgf_draw_textf(Roboto, 355, 405, fontColor, 0.9f, "Settings");
